  ...
  if (!user?.id) {
    return (
      <div className='flex flex-col items-center justify-center bg-red-100 border border-red-500 rounded p-4'>
        ...
        <img src='/assets/error_login.svg' className='w-1/4 max-h-1/4' alt='' />
        <button
              ...
              <div className='py-4 space-y-3 md:space-y-4'>
                ...
                {selectedTier && (
                  <div className='mt-4'>
                    ...
                    <p className='text-sm md:text-base'>
                      Price: ₹
                      {selectedSeat.tiers[selectedTier].price.toFixed(2)} per
                      ticket
                    </p>
                    <p className='text-sm md:text-base'>
                      Seats:{" "}
                      {`${selectedSeat.tiers[selectedTier].seatNumbers} Available`}
                    </p>
                  </div>
                )}
                  ...
                  <div className='flex items-center justify-between mt-4'>
                    ...
                    <div className='text-right'>
                      <p className='text-xl md:text-2xl font-bold'>
                        ₹
                        {(
                          selectedSeat.tiers[selectedTier].price *
                          ticketQuantity
                        ).toFixed(2)}
                      </p>
